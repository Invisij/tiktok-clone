...
export const LiveHubIcon = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const VerifiedIcon = ({ width = '1.4rem', height = '1.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LogoIcon = ({ width = '11.8rem', height = '4.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
